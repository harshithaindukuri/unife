...
import com.example.indukuri.unife.lib.QRGContents;
import com.example.indukuri.unife.lib.QRGEncoder;
import com.example.indukuri.unife.lib.QRGSaver;
...
public class GenerateTicket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button rides = (Button)findViewById(R.id.searchrides);
        ...
        rides.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GenerateTicket.this,Avail_modes.class);
